#!/bin/bash
# ElastAlert2 启动脚本 - 无代理版本
# ElastAlert2 Startup Script - No Proxy Version
...
示例:
    ...
    $0 test error_rules/test_simple.yaml  # 测试规则
    $0 create-index          # 创建索引

注意：此脚本会自动禁用 HTTP/HTTPS 代理以避免连接超时
EOF
}
